...
namespace cs460
{
	...
	public:
		...
		void delete_tree(SceneNode* node, bool clearParentChildren = false);//, bool clearParentChildren = true);		// Recursive function to free the memory of all the nodes in the given tree
